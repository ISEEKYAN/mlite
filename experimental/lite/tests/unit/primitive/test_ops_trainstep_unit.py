...
from megatron.lite.primitive.ops import (
    AllGatherDim0,
...
def test_sp_ops_public_surface_is_available_without_extra_ops_imports():
    assert AllGatherDim0 is not None
    assert AllGatherDim0ForNonSPConsumer is not None
    assert ReduceScatterDim0 is not None
    assert ScatterToSP is not None
